...
/// Represents the preference key for enabling/disabling the gateway management section.
///
/// This module controls whether the gateway/proxy management interface is visible in the sidebar.

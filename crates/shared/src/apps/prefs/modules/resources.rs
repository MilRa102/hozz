...
/// Represents the preference key for enabling/disabling the resource management section.
///
/// This module controls whether the resource management interface is visible in the sidebar.

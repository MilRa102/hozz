...
/// Represents the preference key for enabling/disabling the Docker containers management section.
///
/// This module controls whether the Docker container management interface is visible in the sidebar.
